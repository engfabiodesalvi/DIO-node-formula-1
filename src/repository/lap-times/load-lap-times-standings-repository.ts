...
export const loadLapTimesJsonFile = async(filePathJson: string) => {
    ...
    listLapTimes = jsonFile['constructorStandings'];
    if (listLapTimes.length > 0) {      
        console.log(listLapTimes[0])
        console.log(listLapTimes[1])
        console.log(listLapTimes[2])
...
export const saveLapTimesToJsonFile = async(filePath: string) => {
    try {
        const jsonFile = {constructorStandings: listLapTimes};
...
export const saveExtLapTimesToJsonFile = async(filePath: string, constructorStandingsModel: LapTimeModel[]) => {
    try {
        ...
        listLapTimes = constructorStandingsModel;
